...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Privacy Policy | Motif",
    description:
      "Learn how Motif collects, uses, stores, and protects your information.",
    type: "website",
      ...
      <article className="space-y-10">
        <section>
          ...
          <p className="text-muted-foreground mt-4 text-[17px] leading-7">
            ...
            name, email address, uploaded images, and any information you submit
            through our website.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-muted-foreground mt-4 text-[17px] leading-7">
            We use your information to provide our services, improve the user
            experience, process uploaded files, respond to support requests,
        ...
        <section>
          ...
          <p className="text-muted-foreground mt-4 text-[17px] leading-7">
            Images and files uploaded to Motif are processed only to deliver the
            requested functionality. We do not claim ownership of your content.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-muted-foreground mt-4 text-[17px] leading-7">
            ...
            preferences, improve performance, and understand how visitors use
            our website.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-muted-foreground mt-4 text-[17px] leading-7">
            We work with trusted third-party providers for services such as
            analytics, hosting, authentication, and payment processing. These
        ...
        <section>
          ...
          <p className="text-muted-foreground mt-4 text-[17px] leading-7">
            ...
            protect your information. While no online service can guarantee
            complete security, we continually work to protect your data.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-muted-foreground mt-4 text-[17px] leading-7">
            ...
            is handled, please contact us through the support channels available
            on our website.
          </p>
        </section>
      </article>
