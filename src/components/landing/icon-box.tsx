...
export function IconBox({ icon: Icon, size = 64, className }: { icon: Icon; size?: 64 | 72; className?: string }) {
  return (
    <div
      className={cn(
        "flex shrink-0 items-center rounded-sm justify-center border-2 border-[#8479ff] bg-white text-[#4a3aff] shadow-[0_6px_14px_rgba(74,58,255,0.18)]",
        size === 72 ? "h-18 w-18" : "h-16 w-16",
        className,
      )}
    >
